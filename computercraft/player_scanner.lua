...
local sadPeople = {
    ["Tbnyeet"] = true,
    ["Lilia_Mer"] = true,
    -- Du kannst beliebig viele hinzufÃ¼gen!
}
        ...
        if httpSuccess and response then
            ...
            if readSuccess and rawJson and rawJson ~= "" then
                ...
                if jsonSuccess and data and data.players then
                    -- Daten fÃ¼r den Monitor-Loop zwischenspeichern
...
local function monitorRenderLoop()
    ...
    while true do
        ...
        if #activeSadPeople > 0 then
            ...
            -- Berechne Box-HÃ¶he dynamisch basierend auf Anzahl der "Goyim Slaves"
        ...
        -- Animations-Variablen fÃ¼r den nÃ¤chsten Frame weiterschalten
