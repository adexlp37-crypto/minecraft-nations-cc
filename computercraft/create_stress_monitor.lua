...
-- Monitor perfekt einstellen: GrÃ¶ÃŸere Schrift fÃ¼r das Setup im Bild
...
local function drawUI()
    ...
    -- Ampel-Farbe fÃ¼r Prozenttext & Balken bestimmen
    ...
    -- GefÃ¼llter Teil des Balkens (Farbig)
...
-- Hauptschleife (Aktualisiert alle 0.5 Sekunden fÃ¼r direkte Reaktion)
while true do
    drawUI()
    sleep(0.5)
end
