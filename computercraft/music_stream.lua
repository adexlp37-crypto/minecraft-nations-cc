...
local response = http.get(url, nil, true) -- 'true' ist wichtig fÃ¼r BinÃ¤rdaten (Audio)

if not response then
    error("Error: Konnte keine Verbindung zum Audio-Link herstellen.")
end

print("Spiele Song ab... DrÃ¼cke Strg+T zum Stoppen.")

-- Decoder fÃ¼r das Minecraft-Audioformat laden
local decoder = require("cc.audio.dfpwm").make_decoder()

while true do
    -- Liest Musik-HÃ¤ppchen (16 Kilobyte) aus dem Internet
