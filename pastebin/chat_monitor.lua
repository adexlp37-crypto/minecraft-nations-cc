...
local maxLines = 13        -- Wie viele Zeilen auf den Monitor passen (abhängig von Monitor-Größe und Text-Scale)
...
-- Monitor einrichten
mon.clear()
mon.setTextScale(0.5) -- Skalierung: 1 (normal), 0.5 (klein, mehr Platz), 2 (groß)
-- Bei TextScale 1 passen ca. 19-20 Zeilen auf einen normalen Monitor.
-- Passe maxLines ggf. an, wenn du den Scale änderst.
...
local function updateMonitor()
    ...
    for i = startIdx, #chatHistory do
        ...
        -- Farben setzen (optional: Spielername gelb, Nachricht weiß)
        -- Hier vereinfacht alles in Weiß, oder du parst den String für Farben
        mon.setTextColor(colors.white)
        mon.write(line)
    end
end

print("Chat-Monitor gestartet. Drücke Strg+T zum Beenden.")
